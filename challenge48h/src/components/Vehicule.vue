...
async function vehiclesList() {
  listVehicles.value = (await API.getVehicleData("")).data;
  while (listVehicles.value.next != null) {
    const urlNextPage = listVehicles.value.next.substr(30);
    newlistVehicles.value = (await API.getVehicleData(urlNextPage)).data;
    newlistVehicles.value.results.forEach((vehicles) =>
      listVehicles.value.results.push(vehicles)
    );
      ...
      <div class="box">
        <div class="content">
          ...
          <!-- <ul class="information">
            ...
            <li
              v-if="
                vehicles.max_atmosphering_speed != 'n/a' &&
                vehicles.max_atmosphering_speed != 'unknown'
              "
            >
              Vitesse maximum : {{ vehicles.max_atmosphering_speed }}
            </li>
            <li
              v-if="
