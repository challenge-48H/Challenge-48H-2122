...
async function speciesList() {
  ...
  while (listSpecies.value.next != null) {
    const urlNextPage = listSpecies.value.next.substr(29);
    newlistSpecies.value = (await API.getEspeceData(urlNextPage)).data;
    newlistSpecies.value.results.forEach((species) =>
      listSpecies.value.results.push(species)
    );
      ...
      <div class="box">
        <div class="content">
          ...
          <ul class="information">
            ...
            <li v-if="species.skin_colors != 'n/a'">
            ...
            <li
              ...
              "
            >
              Couleur de cheveux : {{ species.hair_colors }}
            </li>
            <li
              v-if="
                species.eye_colors != 'unknown' && species.eye_colors != 'n/a'
              "
            >
              Couleur des yeux : {{ species.eye_colors }}
            </li>
            <li
              v-if="species.language != 'n/a' && species.language != 'unknown'"
            >
              Langage : {{ species.language }}
            </li>
            <li
              v-if="
